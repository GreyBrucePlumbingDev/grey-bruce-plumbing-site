        ...
        <div className="navbar py-2 ">
          ...
          <div className="navbar-start">
            <div className="dropdown">
              ...
              >
                <li>
                  <a onClick={() => scrollToSection("home")} className={"home"}>
                    Home
                  </a>
                </li>
                <li>
                  <a onClick={() => scrollToSection("services")} className={"services"}>
                    Services
                  </a>
                </li>
                <li>
                  <a onClick={() => scrollToSection("about")} className={"about"}>
                    About Us
                  </a>
                </li>
                <li>
                  <a onClick={() => scrollToSection("reviews")} className={"reviews"}>
                    Reviews
                  </a>
                </li>
                <li>
                  <a onClick={() => scrollToSection("blog")} className={"blog"}>
                    Blog
                  </a>
                </li>
                <li>
                  <a onClick={() => scrollToSection("serviceArea")} className={"serviceArea"}>
                    Service Area
                  </a>
                </li>
              </ul>
            ...
            <Link to="/" className="btn btn-ghost ml-1">
              {settings?.company_logo_url ? (
                <img
                  ...
                  className="h-8 sm:h-9 md:h-10 lg:h-12 xl:h-15"
                />
              ) : (
          ...
          <div className="navbar-center hidden lg:flex justify-center flex-grow mr-25">
            <ul className="menu menu-horizontal px-1">
              <li>
                <a onClick={() => scrollToSection("home")} className={`hover:bg-transparent ${"home"}`}>
                  Home
                </a>
              </li>
              <li>
                <a onClick={() => scrollToSection("services")} className={`hover:bg-transparent ${"services"}`}>
                  Services
                </a>
              </li>
              <li>
                <a onClick={() => scrollToSection("about")} className={`hover:bg-transparent ${"about"}`}>
                  About Us
                </a>
              </li>
              <li>
                <a onClick={() => scrollToSection("reviews")} className={`hover:bg-transparent ${"reviews"}`}>
                  Reviews
                </a>
              </li>
              <li>
                <a onClick={() => scrollToSection("blog")} className={`hover:bg-transparent ${"blog"}`}>
                  Blog
                </a>
              </li>
              <li>
                <a onClick={() => scrollToSection("serviceArea")} className={`hover:bg-transparent ${"serviceArea"}`}>
                  Service Area
                </a>
              </li>
            </ul>
          ...
          <div className="navbar-end flex items-center">
            ...
            <div className="flex flex-col sm:flex-row">
              <a
                ...
                className="btn btn-sm sm:btn-md bg-primary-500 hover:bg-primary-600 text-white border-none mr-1 mb-1 sm:mb-0 sm:mr-2 px-2 sm:px-4"
              >
                Book Now
              </a>
              <a
                onClick={() => scrollToSection("contact")}
                className="btn btn-sm sm:btn-md bg-secondary-700 hover:bg-secondary-800 text-white border-none px-2 sm:px-4"
              >
                Contact Us
              </a>
            </div>
