            ...
            <div className="lg:col-span-1">
              ...
              <div className="bg-white border border-gray-200 p-6 rounded-lg">
                ...
                <p className="italic text-gray-700 mb-4">
                  "The team at {settings?.company_name || "Grey-Bruce Plumbing"} was professional, prompt, and solved
                  our plumbing issue quickly. Highly recommend their services to anyone in {formattedAreaName}!"
                </p>
                <p className="font-semibold">- Satisfied Customer in {formattedAreaName}</p>
              </div>
            </div>
          </div>
        </div>
